          ...
          <CardContent className="space-y-6">
              ...
              {details && (
                  <div className='p-4 border rounded-lg space-y-4 text-lg'>
                      <p><strong>Time to reach:</strong> {details.timeTaken}</p>
                      <p><strong>Weather:</strong> {details.weatherReport}</p>
                      <p><strong>Number of Tolls:</strong> {details.numberOfTolls}</p>
                      <p><strong>Estimated Toll Price:</strong> {details.tollPrice}</p>
                  </div>
              )}
